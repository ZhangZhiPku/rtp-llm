...
export TP_SIZE=1
export EP_SIZE=1
export DEVICE_RESERVE_MEMORY_BYTES=-38192000000     
export RESERVER_RUNTIME_MEM_MB=30240
export MAX_SEQ_LEN=262144
export START_PORT=8000
export ACT_TYPE=BF16
export TOKENIZER_PATH=/zhangzhi/models/qwen3_5_35B
export CHECKPOINT_PATH=/zhangzhi/models/qwen3_5_35B
export MODEL_TYPE=qwen35_moe
export FT_SERVER_TEST=1
export ROCM_DISABLE_CUSTOM_AG=True
export FT_DISABLE_CUSTOM_AR=True
export AITER_ASM_DIR=$(bazelisk info output_base)/external/aiter/aiter_meta/hsa
